...
# Vamos a selecccionar un rango de puertos    
for i in range(20,100):
    # Se crea un paquete por cada interaccion
     # -------- CAPA DE TRANSPORTE -------------------
    ...
    tcp = TCP(dport= i, sport=3000,flags='S')
    ...
    if respuesta[0][0][1].haslayer(TCP):
        ...
        if respuesta[0][0][1]['TCP'].flags== 'SA':
            print('puerto {} abierto'.format(i))
        else:
            print('puerto  {} cerrado'.format(i))
